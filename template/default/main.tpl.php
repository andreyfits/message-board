...
<div class="t_mess">
    ...
    <p><img class="mini_mess" src="files/Lighthouse.jpg" alt="">От
        автора: любое хорошее веб-приложение содержит разделы, доступ к
...
<div class="t_mess">
    ...
    <p><img class="mini_mess" src="files/Desert.jpg" alt="">От
        автора: любое хорошее веб-приложение содержит разделы, доступ к
        которым должен быть ограничен для обычного пользователя. Поэтому у
        разработчиков очень часто возникает задача – создания системы
        авторизации пользователей на сайте, которая предусматривает вывод
...
<ul class="pager">
    ...
    <li>
        <a href="?action=main&amp;page=2">2</a>
    </li>
    <li>
        <a href="?action=main&amp;page=2">&gt;</a>
    </li>
    <li class="last">
        <a href="?action=main&amp;page=2">Последняя</a>
    </li>
</ul>
