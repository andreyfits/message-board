...
<div class="t_mess">
    <h4 class="title_p_mess"><a href="http://localhost/doska/?action=view_mess&amp;id=8">dffdfdgdfg dfg dfgdfgdfgdf
            g</a></h4>
    <p class="p_mess_cat">
    ...
    <p><img class="mini_mess" src="files/Lighthouse.jpg">От
...
<div class="t_mess">
    <h4 class="title_p_mess"><a href="http://localhost/doska/?action=view_mess&amp;id=7">sdfsdf</a></h4>
    <p class="p_mess_cat">
        <strong>Категория:</strong> Автомобили |
        <strong>Тип объявления:</strong> Предложение |
    ...
    <p><img class="mini_mess" src="files/Desert.jpg">От
...
<ul class="pager">
    ...
    <li>
        <a href="http://localhost/doska/?action=main&amp;page=2">2</a>
    </li>
    <li>
